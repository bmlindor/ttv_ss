...
function fit_planet3(filename::String,
  ...
  println("New 2-planet chi-square: ",chisquare(tt0,nplanet,ntrans,init_param,tt,sigtt,jmax,EM))
...
function fit_planet4(jd1,sigma,nyear,p4in,p4out,np4,nphase)
 ...
 # Now,add a 4th planet:
  ...
  @save fitfile p3 lprob_p3 best_p3 lprob_best_p3 p4 lprob_p4 best_p4 lprob_pbest_p4 ntrans nplanet tt0 tt ttmodel sigtt 
  return best_p3,best_p4 
end
# # If the simulation already exists, can just do 2-planet fit
# function fit_planet2(sigma,nyear)

...
ax.plot(data2[:,per_col]./365.25 ,xprob(data2[:,end]),label="16 yrs",linestyle="--")
ax.plot(data3[:,per_col]./365.25 ,xprob(data3[:,end]),label="17 yrs",linestyle="--")
ax.plot(data4[:,per_col]./365.25 ,xprob(data4[:,end]),label="18 yrs",linestyle="-.")
ax.plot(data5[:,per_col]./365.25 ,xprob(data5[:,end]),label="19 yrs")
ax.plot(data6[:,per_col]./365.25 ,xprob(data6[:,end]),label="20 yrs")
ax.plot(data7[:,per_col]./365.25 ,xprob(data7[:,end]),label="21 yrs",linestyle="-.")
ax.plot(data8[:,per_col]./365.25 ,xprob(data8[:,end]),label="22 yrs",linestyle="-.")
ax.plot(data9[:,per_col]./365.25 ,xprob(data9[:,end]),label="23 yrs")
ax.plot(data10[:,per_col]./365.25 ,xprob(data10[:,end]),label="24 yrs",linestyle="-.")
axvline(true_per,linestyle="--",color="black")
text(true_per + true_per/100,1.01,pname)
#inset 
# text(label_xloc,1.05,sim_obs_label)
...
# ax2=fig.add_axes([0.4,0.2,0.3,0.5])
# ax2.plot(data1[:,per_col]./365.25 ,xprob(data1[:,end]),label="15 yrs")
# ax2.plot(data2[:,per_col]./365.25 ,xprob(data2[:,end]),label="16 yrs",linestyle="--")
# ax2.plot(data3[:,per_col]./365.25 ,xprob(data3[:,end]),label="17 yrs",linestyle="--")
# ax2.plot(data4[:,per_col]./365.25 ,xprob(data4[:,end]),label="18 yrs",linestyle="-.")
# ax2.plot(data5[:,per_col]./365.25 ,xprob(data5[:,end]),label="19 yrs")
# ax2.plot(data6[:,per_col]./365.25 ,xprob(data6[:,end]),label="20 yrs")
# ax2.plot(data7[:,per_col]./365.25 ,xprob(data7[:,end]),label="21 yrs",linestyle="-.")
# ax2.plot(data8[:,per_col]./365.25 ,xprob(data8[:,end]),label="22 yrs",linestyle="-.")
# ax2.plot(data9[:,per_col]./365.25 ,xprob(data9[:,end]),label="23 yrs")
# ax2.plot(data10[:,per_col]./365.25 ,xprob(data10[:,end]),label="24 yrs",linestyle="-.")
# ax2.set_xlim(1.81,1.9)
ax.set_xlabel("Planet Period Search Grid [years]")
# xlim(minimum(xgrid_in_yrs)-minimum(xgrid_in_yrs)/10,maximum(xgrid_in_yrs)+.05)

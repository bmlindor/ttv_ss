...
function plot_res(sigma::Float64,nyear::Float64,sim,fitmodel,include_moon::Bool=false)
  ...
  ax2=subplot(122)
  title("Residuals from 2-planet fit with 10 sec noise")
  ...
  tick_params(which="minor",direction="in",top="true",right="true",length=2)
  ax2=subplot(122)
title("Residuals from 3-planet fit with 10 sec noise")
  ...
  ax1=subplot(121)
    ...
    tick_params(which="minor",direction="in",top="true",right="true",length=2)
  ax2=subplot(122)
title("Residuals from 4-planet fit with 10 sec noise")
...
function plot_ttvs(sigma::Float64,nyear::Float64,sim,fitmodel,include_moon::Bool=false)
  ...
  plot(ttsim1,pair_ttvs[1,2,1:n1],color="green",label=label,alpha=0.9,linestyle="--")

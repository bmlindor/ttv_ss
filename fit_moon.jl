...
# If 3-planet fit with moon already exists, can just do 4-planet search
function fit_planet4(jd1,sigma,nyear,p4in,p4out,np4,nphase)
  infile = string("FITS/moon_fit",sigma,"s",nyear,"yrs.jld2")
  m = jldopen(String(infile),"r")
  tt0,tt,ttmodel,sigtt=m["tt0"],m["tt"],m["ttmodel"],m["sigtt"]
 ...
 # Now,add a 4th planet:
  ...
  fitfile = string("FITS/p4moon_fit",sigma,"s",nyear,"yrs.jld2")
  @save fitfile p3 lprob_p3 best_p3 dp lprob_dp best_dp lprob_best_p3 p4 lprob_p4 best_p4 lprob_best_p4 ntrans nplanet tt0 tt ttmodel sigtt p3in p3out np3 nphase p4in p4out np4

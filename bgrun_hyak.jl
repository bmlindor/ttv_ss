...
#sigma = show_args(ARGS)[2]
#nyear = show_args(ARGS)[3]
...
foutput = string("NYR50/",label)
f = jldopen(String(fitfile),"r")
#@load fitfile lprob_best pbest_global nplanet ntrans tt0 tt sigtt
...
#datafile = "OUTPUTS/moon_fittestparams.jld2"
#foutput = string("NYR50/",label)
#moon_mcmc(datafile,foutput,nwalkers,nsteps)
